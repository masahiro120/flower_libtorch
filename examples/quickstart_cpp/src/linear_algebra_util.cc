...
// std::vector<double> LinearAlgebraUtil::subtract_vector(std::vector<double> v1, std::vector<double> v2) {
...
// std::vector<double> LinearAlgebraUtil::add_vector_scalar(std::vector<double> v, double a) {
...
// std::vector<double> LinearAlgebraUtil::multiply_vector_scalar(std::vector<double> v, double a) {
//     for (int i = 0; i < v.size(); i++) {
//         v[i] *= a;
//     }
